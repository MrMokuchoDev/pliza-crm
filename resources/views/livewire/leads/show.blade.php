<div>
    ...
    <div class="flex items-center justify-between mb-4">
        <div class="flex items-center gap-3">
            ...
            <span class="text-sm text-gray-500">{{ $lead->created_at->diffForHumans() }}</span>
    ...
    <div class="grid lg:grid-cols-5 gap-4">
        <!-- Columna izquierda: Info + Acciones (2 cols) -->
                ...
                <div class="p-4">
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex items-center gap-2">
                            <div class="w-2.5 h-2.5 rounded-full" style="background-color: {{ $lead->salePhase->color ?? '#6B7280' }}"></div>
                            <span class="text-xs text-gray-600">{{ $lead->salePhase->name ?? 'Sin fase' }}</span>
                            @if($lead->salePhase?->is_closed)
                                <span class="ml-auto text-xs px-1.5 py-0.5 rounded-full {{ $lead->salePhase->is_won ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700' }}">
                                    {{ $lead->salePhase->is_won ? 'Ganado' : 'Perdido' }}
                                </span>
                            @endif
                        </div>
                    </div>
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-3 group">
                                        <div class="flex items-start justify-between gap-3">
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <p class="text-xs text-gray-400 mt-1.5">{{ $note->created_at->format('d/m/Y H:i') }} &middot; {{ $note->created_at->diffForHumans() }}</p>
                                            </div>
    ...
    <!-- Componente compartido para editar lead -->
                    ...
                    <div class="bg-white px-6 pt-6 pb-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 mt-1">Esta acci&oacute;n no se puede deshacer. El lead y todas sus notas ser&aacute;n eliminados.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white px-6 pt-6 pb-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 mt-1">&iquest;Est&aacute;s seguro de eliminar esta nota?</p>
                            </div>
                        </div>
                    </div>
                    <div class="bg-gray-50 px-6 py-4 flex justify-end gap-3">
