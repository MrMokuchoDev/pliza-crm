<div class="w-full max-w-full overflow-x-hidden">
    <div class="mb-4 lg:mb-6">
        ...
        <p class="text-sm lg:text-base text-gray-600">Resumen de tu actividad comercial</p>
    </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4 mb-6 lg:mb-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 lg:p-6">
            <div class="flex items-center">
                ...
                <div class="ml-3 lg:ml-4 min-w-0">
                    <p class="text-xs lg:text-sm font-medium text-gray-500 truncate">Contactos</p>
                    <p class="text-lg lg:text-2xl font-semibold text-gray-900">{{ number_format($stats['total_leads']) }}</p>
                </div>
            </div>
            <div class="mt-2 lg:mt-4 text-xs lg:text-sm text-gray-500">
                <span class="text-green-600 font-medium">+{{ $stats['leads_this_month'] }}</span> este mes
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 lg:p-6">
            <div class="flex items-center">
                <div class="p-2 lg:p-3 rounded-full bg-yellow-100 text-yellow-600 flex-shrink-0">
                    <svg class="w-5 h-5 lg:w-6 lg:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                    </svg>
                </div>
                <div class="ml-3 lg:ml-4 min-w-0">
                    <p class="text-xs lg:text-sm font-medium text-gray-500 truncate">Abiertos</p>
                    <p class="text-lg lg:text-2xl font-semibold text-gray-900">{{ number_format($stats['open_deals']) }}</p>
                </div>
            </div>
            <div class="mt-2 lg:mt-4 text-xs lg:text-sm text-gray-500">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 lg:p-6">
            <div class="flex items-center">
                ...
                <div class="ml-3 lg:ml-4 min-w-0">
                    <p class="text-xs lg:text-sm font-medium text-gray-500 truncate">Ganados</p>
                    <p class="text-lg lg:text-2xl font-semibold text-gray-900">{{ number_format($stats['won_deals']) }}</p>
                </div>
            </div>
            <div class="mt-2 lg:mt-4 text-xs lg:text-sm text-gray-500">
                Conv: <span class="text-green-600 font-medium">{{ $stats['conversion_rate'] }}%</span>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 lg:p-6">
            <div class="flex items-center">
                ...
                <div class="ml-3 lg:ml-4 min-w-0">
                    <p class="text-xs lg:text-sm font-medium text-gray-500 truncate">Valor</p>
                    <p class="text-lg lg:text-2xl font-semibold text-gray-900">${{ number_format($stats['total_won_value'], 0, ',', '.') }}</p>
                </div>
            </div>
            <div class="mt-2 lg:mt-4 text-xs lg:text-sm text-gray-500">
                <span class="text-red-600 font-medium">{{ $stats['lost_deals'] }}</span> perdidos
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 mb-6 lg:mb-8">
        <!-- Negocios por Fase -->
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 lg:p-6">
            <h3 class="text-base lg:text-lg font-semibold text-gray-900 mb-3 lg:mb-4">Negocios por Fase</h3>
            <div class="space-y-3">
                @foreach($dealsByPhase as $phase)
                    <div>
                        <div class="flex justify-between text-xs lg:text-sm mb-1">
                            <span class="text-gray-600 truncate mr-2">{{ $phase['name'] }}</span>
                            <span class="font-medium whitespace-nowrap">{{ $phase['count'] }}
                                @if($phase['value'] > 0)
        ...
        <!-- Leads por Fuente -->
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 lg:p-6" wire:ignore>
            <h3 class="text-base lg:text-lg font-semibold text-gray-900 mb-3 lg:mb-4">Contactos por Fuente</h3>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 lg:p-6 mb-6 lg:mb-8">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-3 lg:mb-4">
            <h3 class="text-base lg:text-lg font-semibold text-gray-900">Tendencia de Contactos</h3>
            <select wire:model.live="trendPeriod" class="text-sm border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 w-full sm:w-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 lg:p-6">
        <h3 class="text-base lg:text-lg font-semibold text-gray-900 mb-3 lg:mb-4">Funnel de Conversión</h3>
