    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
            ...
            <div class="hidden lg:block overflow-x-auto">
                <table class="w-full">
                    <thead class="bg-gray-50 dark:bg-gray-700/50 border-b border-gray-100 dark:border-gray-700">
                        <tr>
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Usuario</th>
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Email</th>
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Rol</th>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                ...
                                <td class="px-6 py-4">
                                    @php
                                        ...
                                        $roleColor = $roleColors[$user->role?->name] ?? 'bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300';
                                    @endphp
        ...
        @else
            ...
            <div class="p-12 text-center">
                ...
                <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-1">No hay usuarios</h3>
                <p class="text-gray-500 dark:text-gray-400 mb-4">Crea el primer usuario del sistema</p>
                @if($canCreate)
                    <button wire:click="openCreateModal"
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label for="password" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                        Contrasena @if(!$editingId)<span class="text-red-500">*</span>@else<span class="text-gray-400 dark:text-gray-500 text-xs">(dejar vacio para mantener)</span>@endif
                                    </label>
                                    <input type="password"
                                           id="password"
                                           wire:model="password"
